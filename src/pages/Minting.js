...
const Minting = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        ...
        const bummyNFTAmount = 5600-response.data.count;
    ...
    axios
      ...
      .then((response) => {
        console.log(response.data);
        const suriNFTAmount = 5600-response.data.count;
  ...
  const BummyGraphHeight = (BummyAmount / 5600) * 177;
  const SuriGraphHeight = (SuriAmount / 5600) * 177;
